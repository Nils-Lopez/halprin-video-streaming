<div align="center">
  <h1 align="center"><a aria-label="Contredanse life-art" href="https://github.com/contredanse/life-art">NextJs Monorepo</a></h1>
...
│
├── packages
│   ├── common                 (basic ts libs)
│   │   ├── src/
│   │   ├── CHANGELOG.md
│   │   ├── package.json
│   │   └── tsconfig.json
│   │
│   ├── db-main               (basic db layer with prisma)
│       ├── prisma/
│       ├── src/
│       ├── CHANGELOG.md
│       ├── package.json
